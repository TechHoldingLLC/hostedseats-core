...
var PaymentCollection = /** @class */ (function () {
    /**
     * @ignore
     */
    function PaymentCollection(client) {
        this.client = client;
    }
    /**
     ...
     * })
     */
    PaymentCollection.prototype.create = function (body, query, headers) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.client.fetch("/admin/payment-collections", {
                            method: "POST",
                            headers: headers,
                            body: body,
                            query: query,
     ...
     * })
     */
    PaymentCollection.prototype.delete = function (id, headers) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.client.fetch("/admin/payment-collections/".concat(id), {
                            method: "DELETE",
                            headers: headers,
                        })];
                    case 1: return [2 /*return*/, _a.sent()];
     ...
     * })
     */
    PaymentCollection.prototype.markAsPaid = function (id, body, query, headers) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.client.fetch("/admin/payment-collections/".concat(id, "/mark-as-paid"), {
                            method: "POST",
                            headers: headers,
                            body: body,
                            query: query,
