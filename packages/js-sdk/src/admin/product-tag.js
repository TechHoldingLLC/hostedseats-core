...
var ProductTag = /** @class */ (function () {
    /**
     * @ignore
     */
    function ProductTag(client) {
        this.client = client;
    }
    /**
     ...
     * })
     */
    ProductTag.prototype.create = function (body, query, headers) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.client.fetch("/admin/product-tags", {
                        method: "POST",
                        headers: headers,
                        body: body,
                        query: query,
     ...
     * })
     */
    ProductTag.prototype.update = function (id, body, query, headers) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.client.fetch("/admin/product-tags/".concat(id), {
                        method: "POST",
                        headers: headers,
                        body: body,
                        query: query,
     ...
     */
    ProductTag.prototype.list = function (query, headers) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.client.fetch("/admin/product-tags", {
                        headers: headers,
     ...
     * Learn more about the `fields` property in the [API reference](https://docs.medusajs.com/api/store#select-fields-and-relations).
     */
    ProductTag.prototype.retrieve = function (id, query, headers) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.client.fetch("/admin/product-tags/".concat(id), {
                        query: query,
     ...
     * })
     */
    ProductTag.prototype.delete = function (id, headers) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.client.fetch("/admin/product-tags/".concat(id), {
                        method: "DELETE",
