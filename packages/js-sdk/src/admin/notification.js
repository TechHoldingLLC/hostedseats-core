...
var Notification = /** @class */ (function () {
     ...
     */
    Notification.prototype.retrieve = function (id, query, headers) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.client.fetch("/admin/notifications/".concat(id), {
                            method: "GET",
                            headers: headers,
                            query: query,
                        })];
     ...
     * Learn more about the `fields` property in the [API reference](https://docs.medusajs.com/api/store#select-fields-and-relations).
     */
    Notification.prototype.list = function (query, headers) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.client.fetch("/admin/notifications", {
                            method: "GET",
                            headers: headers,
                            query: query,
                        })];
