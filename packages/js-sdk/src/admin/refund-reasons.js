...
var RefundReason = /** @class */ (function () {
    /**
     * @ignore
     */
    function RefundReason(client) {
        this.client = client;
    }
    /**
     ...
     *
     */
    RefundReason.prototype.list = function (query, headers) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.client.fetch("/admin/refund-reasons", {
                            query: query,
                            headers: headers,
                        })];
