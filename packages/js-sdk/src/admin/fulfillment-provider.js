...
var FulfillmentProvider = /** @class */ (function () {
     ...
     * @ignore
     */
    function FulfillmentProvider(client) {
        this.client = client;
    }
    /**
     ...
     */
    FulfillmentProvider.prototype.list = function (query, headers) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.client.fetch("/admin/fulfillment-providers", {
                            method: "GET",
                            headers: headers,
                            query: query,
                        })];
     ...
     * })
     */
    FulfillmentProvider.prototype.listFulfillmentOptions = function (id, headers) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.client.fetch("/admin/fulfillment-providers/".concat(id, "/options"), {
                            method: "GET",
                            headers: headers,
                        })];
                    case 1: return [2 /*return*/, _a.sent()];
